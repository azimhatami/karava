...
function AdminUserListRow({ user }) {
  ...
  return (
    <div className="flex h-[79px] w-full items-center justify-between border-b border-black px-1 py-1">
      ...
      <div className="flex flex-col items-end gap-[9px] text-right">
...
function AdminRecentUsers() {
  ...
  return (
    <section className="w-full max-w-[912px]">
      ...
      <div className="flex w-full max-w-[912px] flex-col gap-[22px] bg-white p-2.5">
